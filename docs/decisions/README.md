...
Short records of the decisions taken while building Cutright, so nobody (including future
...
| [0004](0004-app-name-cutright.md) | Product name: **Cutright**, published by Viddescriptor (renamed from "Claude Video Editor") | Accepted 2026-08-17 (owner chose) |
